...
class AulaControlador:
    ...
    async def create(self, request: Request):
        try:
            ...
            return JSONResponse({"message": "Aula creada exitosamente", "data": {
                "id": str(new_aula.id),
                "nombre": new_aula.nombre,
                "capacidad": new_aula.capacidad,
                "id_estado_aula": str(new_aula.id_estado_aula),
                "id_tipo_aula": str(new_aula.id_tipo_aula)
            }}, status_code=201)
        except Exception as e:
            return JSONResponse({"error": "Error al crear el aula", "detail": str(e)}, status_code=500)
    ...
    async def get(self, request: Request):
        try:
            ...
            return JSONResponse({"error": "Error al obtener las aulas", "detail": str(e)}, status_code=500)
